...
public class MainActivity extends AppCompatActivity {
    ...
    void doConvert() {
        ...
        double isian = Double.parseDouble(inputTxt.getText().toString());
        double conv = convertUnit(selectedRadio.getText().toString(), unitOri.getSelectedItem().toString(), unitConv.getSelectedItem().toString(), isian);
        outputTxt.setText(strResult(conv, roundBox.isChecked()));
    }
}
